...
public class MaquinaTragaperras {
	public static void main(String[] args) {
		...
		System.out.println("BIENVENIDO A LA MAQUINA TRAGAPERRAS DE PEPELIRROJO");
		System.out.println("¿Cuantas veces quieres jugar?");
		int c = sc.nextInt();
		sc.nextLine();
		for (int j = 0; j < c; j++) {
			...
			String simb3 = null;
			while (!maquina) {
				// Numero Aleatorio de la tirada
				int tirada = (int) Math.floor(Math.random() * 24 + 1);
				// Tirada introducida por Scanner
